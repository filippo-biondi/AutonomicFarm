...
/**
 * Namespace for the implementation of Autonomic Farm with native C++ threads.
 */
namespace native_af
{
	/**
	 * Class that implements the Autonomic %Farm pattern.
	 */
	class AutonomicFarm
	{
	private:
	...
	public:
		...
		void start();
		/**
		 * Stop the AutonomicFarm. This method will stop the Farm, the monitor and the MAPE loop.
