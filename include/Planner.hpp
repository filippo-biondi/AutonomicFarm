...
public:
	 ...
	 * @param min_workers the minimum number of workers that can be in the farm.
	 ...
	 */
	Planner(unsigned int current_workers, unsigned int min_workers, unsigned int max_workers, double time_to_recover_queue, double wait_after_action);
